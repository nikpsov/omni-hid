...
1. Compiles the core telemetry library into `bin\OmniHid.Core.dll`.
...
```cmd
# Run interactive menu (options 0 to U)
bin\omni-hid.exe
...
For full details on all CLI subcommands and diagnostic tools, see the [CLI Reference](cli-reference.md).
